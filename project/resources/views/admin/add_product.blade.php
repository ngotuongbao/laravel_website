        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="position-center">
                    <form role="form" action="/save-product" enctype="multipart/form-data" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none;" rows="5" name="product_content" class="form-control" id="exampleInputPassword1" placeholder="Mô tả sản phẩm"></textarea> 
                        </div>
                        <div class="form-group">
