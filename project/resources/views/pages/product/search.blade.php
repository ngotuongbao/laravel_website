		...
		<div class="row">
			...
			<div class="col-sm-9 padding-right">
				...
				<div class="features_items"><!--Search_items-->
					...
					@foreach($search_product as $key => $s)
					<div class="col-sm-4">
						<div class="product-image-wrsper">
							<div class="single-products">
								<div class="productinfo text-center">
									<a href="/product-details/{{$s->product_id}}">
									<img src="upload/product/{{$s->product_image}}" height="200" style="object-fit: contain;" alt="" />
									<h2>{{number_format($s->product_price,0,',','.')}} VND</h2>
									<p>{{$s->product_name}}</p>
									<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm</a>
									<a href="/product-details/{{$s->product_id}}" class="btn btn-default add-to-cart"><i class="fa fa-info-circle"></i>Chi tiết</a>
								</a>
								</div>
